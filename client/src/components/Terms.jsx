...
L'accès et l’utilisation du Site, l’inscription sur le Site et la souscription à l’un des Services proposés par Ornikar sur le Site sont soumis à votre acceptation sans réserve des présentes CGU. 

D’où l’intérêt de bien les lire! 

QCMED pourra suspendre toute inscription et le cas échéant résilier le compte de tout Utilisateur en cas de non-respect des CGU, sans préjudice de tous dommages et intérêts que pourrait solliciter Ornikar.

QCMED se réserve la possibilité de modifier et de mettre à jour les CGU du Site à tout moment. Les nouvelles CGU, qui vous seront notifiées sur le Site et/ou par l’intermédiaire de votre Compte, ne seront applicables qu’après leur entrée en vigueur. Vous devez vous référer avant toute utilisation du Site à la dernière version des CGU accessible à tout moment sur le Site à l’adresse suivante : https://www.ornikar.com/a-propos/conditions-generales-d-utilisation. 
...
Une fois inscrit(e), Vous pourrez acheter les produits et/ou Services proposés à la vente sur le Site dans les conditions et modalités prévues dans nos conditions générales de vente, que nous vous invitons à lire attentivement à l’adresse suivante : https://www.ornikar.com/articles/conditions-generales-de-vente.
...
Si le cas de force majeure ou l’événement interrompant la disponibilité du Site se poursuit pendant une période de plus de trente (30) jours, Ornikar peut alors, de plein droit mettre fin aux CGU à tout moment. Il est expressément convenu que cette résiliation n'ouvre droit à aucune indemnité au profit de l'Utilisateur. 
...
Services
Comme expliqué plus haut, Ornikar propose deux types de Services payants :
...
Ornikar se réserve le droit d’adapter, de faire évoluer ou de supprimer certains Services sans que l’Utilisateur ne puisse s’en prévaloir.
...
Tout Utilisateur s'interdit tout usage du Site qui serait susceptible de porter atteinte aux droits d’Ornikar ou qui serait susceptible de causer un dommage à Ornikar et à ses partenaires. Tout Utilisateur s'interdit tout usage du Site qui serait de nature à porter atteinte à l'intégrité de l'infrastructure technique d’Ornikar, notamment ses serveurs informatiques. 
...
Les CGU entrent en vigueur à compter de leur acceptation par les Utilisateurs et prennent fin lors de la clôture de Votre dernier Compte en activité. À cet égard, tout Utilisateur peut demander la désactivation temporaire ou la fermeture définitive de son Compte à tout moment en envoyant un courriel à hello@ornikar.com pour la partie Education et à assurance@ornikar.com pour la partie Assurance.

En sus de ce qui précède, Ornikar se réserve expressément la possibilité de suspendre et/ou résilier un Compte, de plein droit et sans autre formalité, dans les cas suivants :

en cas de manquement d'un Utilisateur à l'une quelconque des obligations prévues aux CGU. Ornikar informera l'Utilisateur de ladite suspension et/ou résiliation ainsi que de ses motifs. Une mesure de suspension peut être suivie immédiatement ou non d'une mesure de résiliation si Ornikar le juge utile à la conservation de ses intérêts ainsi qu'à ceux des tiers, notamment en cas d'atteinte grave aux CGU. Des mesures de suppression d'accès à tout ou partie du Site peuvent également être mises en œuvre en parallèle par Ornikar ;
...
Les CGU seront exécutées et interprétées conformément au droit français. En cas de litige, l’Utilisateur s'adressera préalablement à Ornikar pour obtenir une solution amiable.
...
Pour tout renseignement, vous pouvez contacter Ornikar par voie postale à l’adresse suivante : Ornikar, 170 boulevard de la Villette à Paris (75019), ou par email à à l’adresse hello@ornikar.com pour la partie Education et à l’adresse assurance@ornikar.com pour la partie Assurance.

Conformément aux articles L.616-1 et R.616-1 du code de la consommation, Ornikar a mis en place un dispositif de médiation de la consommation. L'entité de médiation retenue est : SAS CNPM - MÉDIATION - CONSOMMATION. En cas de litige, le consommateur pourra déposer sa réclamation sur le site http://cnpm-mediation-consommation.eu ou par voie postale en écrivant à “CNPM MÉDIATION-CONSOMMATION - 27, avenue de la Libération – 42400 SAINT-CHAMOND”.
                </div>
            </div>
